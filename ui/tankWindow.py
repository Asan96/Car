...
class Ui_tankWindow(object):
    def setupUi(self, tankWindow):
        ...
        self.actionqiehua = QtWidgets.QAction(tankWindow)
        self.actionqiehua.setObjectName("actionqiehua")
        self.actionsdsad = QtWidgets.QAction(tankWindow)
        self.actionsdsad.setObjectName("actionsdsad")
        self.actionwewe = QtWidgets.QAction(tankWindow)
        self.actionwewe.setObjectName("actionwewe")
        self.menu.addAction(self.actionsdsad)
        self.menu.addAction(self.actionqiehua)
        self.menu_2.addAction(self.actionwewe)
    ...
    def retranslateUi(self, tankWindow):
        ...
        self.actionqiehua.setText(_translate("tankWindow", "退出"))
        self.actionsdsad.setText(_translate("tankWindow", "切换"))
        self.actionwewe.setText(_translate("tankWindow", "使用说明"))
