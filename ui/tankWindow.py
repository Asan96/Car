...
"")
        ...
        self.car_backward.setGeometry(QtCore.QRect(770, 220, 61, 51))
        self.car_backward.setStyleSheet("background-color:rgb(99, 180, 255);color:rgb(243, 243, 243);border-bottom-left-radius:5px;border-bottom-right-radius:5px;font-size:14px;font-weight:500;font-family:\'微软雅黑\';")
        ...
        self.car_rotate.setGeometry(QtCore.QRect(900, 120, 61, 51))
        self.car_rotate.setStyleSheet("background-color:rgb(3, 198, 176);color:rgb(243, 243, 243);border-radius:5px;font-size:14px;font-weight:500;font-family:\'微软雅黑\';")
        self.car_rotate.setObjectName("car_rotate")
        self.car_right = QtWidgets.QPushButton(self.tab_control)
        self.car_right.setGeometry(QtCore.QRect(710, 170, 61, 51))
        self.car_right.setStyleSheet("background-color:rgb(99, 180, 255);color:rgb(243, 243, 243);border-top-left-radius:5px;border-bottom-left-radius:5px;font-size:14px;font-weight:500;font-family:\'微软雅黑\';")
        self.car_right.setObjectName("car_right")
        self.label_4 = QtWidgets.QLabel(self.tab_control)
        self.label_4.setGeometry(QtCore.QRect(800, 60, 91, 41))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(14)
        self.label_4.setFont(font)
        self.label_4.setStyleSheet("color:rgb(85, 170, 255);font-family:\'微软雅黑\';")
        self.label_4.setObjectName("label_4")
        self.car_cam_left = QtWidgets.QPushButton(self.tab_control)
        self.car_cam_left.setGeometry(QtCore.QRect(870, 420, 61, 51))
        self.car_cam_left.setStyleSheet("background-color:#01AAED;color:#F3F3F3;border-top-right-radius:5px;border-bottom-right-radius:5px;font-size:14px;font-weight:500;font-family:\'微软雅黑\';")
        self.car_cam_left.setObjectName("car_cam_left")
        self.car_forward = QtWidgets.QPushButton(self.tab_control)
        self.car_forward.setGeometry(QtCore.QRect(770, 120, 61, 51))
        self.car_forward.setWhatsThis("")
        self.car_forward.setStyleSheet("background-color:rgb(99, 180, 255);color:rgb(243, 243, 243);border-top-left-radius:5px;border-top-right-radius:5px;font-size:14px;font-weight:500;font-family:\'微软雅黑\';")
        self.car_forward.setObjectName("car_forward")
        self.car_cam_down = QtWidgets.QPushButton(self.tab_control)
        self.car_cam_down.setGeometry(QtCore.QRect(810, 370, 61, 51))
        self.car_cam_down.setStyleSheet("background-color:#01AAED;color:#F3F3F3;border-top-left-radius:5px;border-top-right-radius:5px;font-size:14px;font-weight:500;font-family:\'微软雅黑\';")
        ...
        self.car_stop.setGeometry(QtCore.QRect(900, 220, 61, 51))
        self.car_stop.setStyleSheet("background-color:rgb(255, 85, 0);color:rgb(243, 243, 243);border-radius:5px;font-size:14px;font-weight:500;font-family:\'微软雅黑\';")
        self.car_stop.setObjectName("car_stop")
        self.car_cam_up = QtWidgets.QPushButton(self.tab_control)
        self.car_cam_up.setGeometry(QtCore.QRect(810, 470, 61, 51))
        self.car_cam_up.setStyleSheet("background-color:#01AAED;color:#F3F3F3;border-bottom-left-radius:5px;border-bottom-right-radius:5px;font-size:14px;font-weight:500;font-family:\'微软雅黑\';")
        ...
        self.label_5.setStyleSheet("color:rgb(85, 170, 255);font-family:\'微软雅黑\';")
        self.label_5.setObjectName("label_5")
        self.car_cam_right = QtWidgets.QPushButton(self.tab_control)
        self.car_cam_right.setGeometry(QtCore.QRect(750, 420, 61, 51))
        self.car_cam_right.setStyleSheet("background-color:#01AAED;color:#F3F3F3;border-top-left-radius:5px;border-bottom-left-radius:5px;font-size:14px;font-weight:500;font-family:\'微软雅黑\';")
        self.car_cam_right.setObjectName("car_cam_right")
        self.car_left = QtWidgets.QPushButton(self.tab_control)
        self.car_left.setGeometry(QtCore.QRect(830, 170, 61, 51))
        self.car_left.setStyleSheet("background-color:rgb(99, 180, 255);color:rgb(243, 243, 243);border-top-right-radius:5px;border-bottom-right-radius:5px;font-size:14px;font-weight:500;font-family:\'微软雅黑\';")
        ...
        self.voice_control.setStyleSheet("font-family:\'微软雅黑\';font-size:14px;background-color:rgb(99, 180, 255);border-radius:5px;color:#F8F8F8")
        ...
        self.voice_text_composite.setStyleSheet("font-family:\'微软雅黑\';font-size:14px;background-color:rgb(99, 180, 255);border-top-right-radius:5px;border-bottom-right-radius:5px;color:#F8F8F8")
        ...
        self.voice_chat.setStyleSheet("font-family:\'微软雅黑\';font-size:14px;background-color:rgb(99, 180, 255);border-radius:5px;color:#F8F8F8")
...
"background-color:white;font-family:\'微软雅黑\';")
        ...
        self.voice_audio_start.setStyleSheet("font-family:\'微软雅黑\';font-size:14px;background-color:rgb(99, 180, 255);border-radius:5px;color:#F8F8F8")
        ...
        self.voice_audio_stop.setStyleSheet("font-family:\'微软雅黑\';font-size:14px;background-color:#FF0000;border-radius:5px;color:#F8F8F8")
        ...
        self.voice_audio_play.setStyleSheet("font-family:\'微软雅黑\';font-size:14px;background-color:rgb(24, 157, 50);border-radius:5px;color:#F8F8F8")
...
"QPushButton{background-color:rgb(85, 170, 127);border-bottom-left-radius:5px;color:#F2F2F2;border-right:1px solid #F8F8F8;font-family:\'微软雅黑\';font-size:14px;}")
...
"QPushButton{background-color:rgb(85, 170, 127);color:#F2F2F2;border-radius:0px;border-right:1px solid #F8F8F8;font-family:\'微软雅黑\';font-size:14px;}")
...
"QPushButton{background-color:rgb(85, 170, 127);border-radius:0px;color:#F2F2F2;border-right:1px solid #F8F8F8;font-family:\'微软雅黑\';font-size:14px;}")
...
"QPushButton{background-color:rgb(85, 170, 127);border-bottom-right-radius:5px;color:#F2F2F2;font-family:\'微软雅黑\';font-size:14px;}")
        ...
        self.video_pannel.setStyleSheet("background-color:black;")
