...
class ModeDialog(QtWidgets.QDialog, Ui_modeDialog):
    def __init__(self):
        ...
        self.option_pc.setIcon(QIcon(os.path.join(self.app_path, 'static/image/logo_pc.png')))
        self.option_tank.setIcon(QIcon(os.path.join(self.app_path, 'static/image/logo_tank.png')))
        self.option_mac.setIcon(QIcon(os.path.join(self.app_path, 'static/image/logo_mac.png')))
